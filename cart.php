...
$Samsung = new smartphone('Samsung', 2000);
$Samsung2 = new smartphone('Samsung', 2000);
$Samsung3 = new smartphone('Samsung', 2000);
$Samsung4 = new smartphone('Samsung', 2000);
 
$lenovo = new smartphone('Lenovo', 3000);
$lenovo3 = new smartphone('Lenovo', 3000);
$korzina = new Cart();
$korzina->addProduct($Samsung); //добавляю товар в корзину
$korzina->addProduct($Samsung2); //добавляю товар в корзину
$korzina->addProduct($Samsung3); //добавляю товар в корзину
$korzina->addProduct($Samsung4); //добавляю товар в корзину
 
$korzina->addProduct($lenovo); //добавляю товар в корзину
$korzina->addProduct($lenovo3); //добавляю товар в корзину
 
 
//$korzina->deleteOneProduct($Samsung);
echo '<br>';
